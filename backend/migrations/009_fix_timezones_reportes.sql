-- ========================================================================================
-- SCRIPT DE CORRECCIÓN DE ZONA HORARIA PARA REPORTES - EL CAFECITO
-- ========================================================================================
-- Este script corrige un bug en el cálculo de los límites de inicio y fin del día
-- en los reportes operacionales. Las ventas recientes no aparecían porque se 
-- guardaban en UTC y el filtro del día actual cortaba antes de tiempo.
-- ========================================================================================
