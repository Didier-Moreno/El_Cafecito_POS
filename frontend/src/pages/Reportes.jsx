import { ShoppingCart, Clock, Star, TrendingUp, AlertCircle, RefreshCw } from 'lucide-react'
                ...
                <table className="w-full text-sm">
                  ...
                  <tfoot>
                    <tr className="bg-cafe-crema border-t-2 border-cafe-beige">
                      <td colSpan={2} className="px-5 py-3 text-xs font-bold text-cafe-claro uppercase tracking-wider">
                        Total del Día
                      </td>
